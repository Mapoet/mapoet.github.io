...
gantt
    ...
    section 核心功能
    基础架构实现    :done, basic, 2019-01-01, 2019-06-01
    多线程支持      :done, thread, 2019-03-01, 2019-09-01
    图结构优化      :done, graph, 2019-05-01, 2019-12-01
    
    section 高级功能
    自适应机制       :active, adaptive, 2020-01-01, 2020-12-01
    分布式计算       :distributed, 2020-06-01, 2021-06-01
    性能优化         :optimize, 2021-01-01, 2021-12-01
    
    section 扩展应用
    深度学习集成     :deep, 2022-01-01, 2022-12-01
    边缘计算         :edge, 2023-01-01, 2023-12-01
    量子计算         :quantum, 2024-01-01, 2024-12-01
```

...
!["神经网络结构演化示意（MLP→CNN→RNN→Transformer）"](/images/1_j-6hYKWRjLXzcHDrz2_heA.png)
...
!["深度学习预报、业务数值预报与再分析场的多变量对比示例"](/images/图片1.png)
...
!["大模型 scaling 相关曲线的整理拼图"](/images/98592f1d-1d20-4c88-a681-9d4dac0289d4_2014x1130.jpg)
...
!["Transformer 编码器—解码器结构示意"](/images/1_7Nfcfr0YkDSxpsa2aVI5aQ.png)
...
!["训练数据规模与泛化误差的典型分段示意"](/images/scaling-law.png)
